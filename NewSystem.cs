// Copied from https://github.com/NethermindEth/int256/
using System;
...
namespace System
{
    ...
    {
        internal static byte[] ToBytes32(this BigInteger value, bool isBigEndian)
        {
            byte[] bytes32 = new byte[32];
            value.ToBytes32(bytes32.AsSpan(), isBigEndian);
            return bytes32;
        }
        internal static void ToBytes32(this BigInteger value, Span<byte> target, bool isBigEndian)
        {
            if (!isBigEndian)
            {
    ...
    interface IInteger<T> where T : IInteger<T>
    {
    ...
    public readonly struct UInt256 : IEquatable<UInt256>, IComparable, IComparable<UInt256>, IInteger<UInt256>,
        IConvertible
    {
